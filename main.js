...
function country(str) {
    if (str === void 0) { str = "pakistan"; }
    // Split the string into an array of characters, sort the array, and join the characters back into a string
    return str;
}
// Log the result of calling alphabet_order with the input string "webmaster" to the console
console.log(country());
function Country(str, str1) {
    if (str === void 0) { str = "pakistan"; }
    if (str1 === void 0) { str1 = "England"; }
    // Split the string into an array of characters, sort the array, and join the characters back into a string
    return "".concat(str, " ").concat(str1);
}
// Log the result of calling alphabet_order with the input string "webmaster" to the console
console.log(Country());
function Admission(name, Qualification, email) {
    console.log("my name is ".concat(name, " i am ").concat(Qualification, " my email is ").concat(email));
}
Admission("Nazar Baloch", "under  Graguated", "mazarinazarali04@gmail.com");
function weatherCondition(temperature) {
    if (temperature === void 0) { temperature = "23 Celcius"; }
    return "Today the temperature will rise till ".concat(temperature);
}
